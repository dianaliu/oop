...
/**
 * A pretty printer for C++.  Modified from original xtc.lang.JavaPrinter.
 *
 *	(from JavaPrinter):
 ...
 * The actual precedence values are the standard C++ precedence
...
public class CPPPrinter extends Visitor {
  ...
  public void visitPackageDeclaration(GNode n) {  
    ...
    printer.indent().p(n.getNode(0)).p("namespace ").p(n.getNode(1)).pln(';');
    isOpenLine  = false;
  }
  ...
  public void visitTypeParameter(GNode n) {
    printer.p(n.getString(0));
    if (null != n.get(1)) printer.p(":").p(n.getNode(1));
  }
  ...
  public void visitVirtualTableDeclaration(GNode n) {
    printer.pln().pln("/*\n* VIRTUAL TABLE GOES HERE\n*/").pln();
  }
}
